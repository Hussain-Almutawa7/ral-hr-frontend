            ...
            {isHR &&
                <div>
                    <div className="actions page-actions">
                        <Button variant="primary" onClick={() => navigate(`/leave/types/new`)}>Add a Leave Type</Button>
                    </div>
                            ...
                            <tbody>
                                {leaveTypes.map((type) => (
                                    ...
                                    >
                                        ...
                                        <td><Button variant="secondary" onClick={() => navigate(`/leave/types/${type._id}/edit`)}>Edit</Button></td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
